...
const PageFooter = () => {
    ...
    return (
        <footer className="page-footer col-sm-12">
            <p className="type-secondary mod-footer">Made with
                &nbsp;
                <svg style={{ width : "20px", verticalAlign : "middle", }} viewBox="0 0 600 600"
                     xmlns="http://www.w3.org/2000/svg">
                    <circle fill="#999999" cx="299.5" cy="299.6" r="50.2"/>
                    <path fill="#999999"
                ...
                &nbsp;
                in Kingston, Washington, sometime in 2017
            </p>
        </footer>
    )
